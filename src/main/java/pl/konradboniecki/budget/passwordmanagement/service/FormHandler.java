...
public class FormHandler {
    ...
    @Autowired
    public FormHandler(RestTemplate restTemplate, NewPasswordRequestService newPasswordRequestService, MailClient mailClient, AccountFacade accountFacade) {
    ...
    public void handleForm(NewPasswordForm newPasswordForm) throws Exception {
        ...
        mailClient.requestMailWithResetCode(activationLinkRequest);
    ...
    private void saveNewPasswdRequestToDb(NewPasswordForm newPasswordForm, ActivationLinkRequest activationLinkRequest){
        String id = activationLinkRequest.getAccount().getId();
